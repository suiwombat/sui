...
RichLinkerRunInfo = provider(
    fields={
        "exe": provider_field(typing.Any, default=None),
        "flags": provider_field(typing.Any, default=None),
    }
)
...
LinkerInfo = provider(
    ...
    fields={
        ...
        "shlib_interfaces": provider_field(
        ...
        "shared_library_versioned_name_format": provider_field(
            typing.Any, default=None
        ),  # str
        ...
        "independent_shlib_interface_linker_flags": provider_field(
            typing.Any, default=None
        ),
        ...
        "produce_interface_from_stub_shared_library": provider_field(
            typing.Any, default=None
        ),  # bool
    },
)
...
StripFlagsInfo = provider(
    # @unsorted-dict-items
    fields={
        "strip_debug_flags": provider_field(
            typing.Any, default=None
        ),  # [["str"], None]
        "strip_non_global_flags": provider_field(
            typing.Any, default=None
        ),  # [["str"], None]
...
DistLtoToolsInfo = provider(
    # @unsorted-dict-items
    fields={
        "planner": provider_field(typing.Any, default=None),
        "opt": provider_field(typing.Any, default=None),
        "prepare": provider_field(typing.Any, default=None),
        "copy": provider_field(typing.Any, default=None),
    },
)
...
CxxToolchainInfo = provider(
    # @unsorted-dict-items
    fields={
        "conflicting_header_basename_allowlist": provider_field(
            typing.Any, default=None
        ),
...
def cxx_toolchain_infos(
    ...
    if as_compiler_info != None:
        ...
        unkeyed_variables["asppflags"] = _shell_quote(
            as_compiler_info.preprocessor_flags
        )
    ...
    return [
        toolchain_info,
        placeholders_info,
        CxxPlatformInfo(name=platform_name, deps_aliases=platform_deps_aliases),
    ]
